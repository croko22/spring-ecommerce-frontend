...
let MOCK_ORDERS_STATE: Order[] = [
  { orderId: 'ORD-001', items: [{ productId: 'p-001', name: 'Aurora Running Shoes', price: 89.9, quantity: 1 }], shipping: { fullName: 'Juan Perez', documentType: 'dni', documentNumber: '12345678', address: 'Av. Javier Prado 123, Lima', phone: '+51987654321', region: 'Lima' }, subtotal: 89.9, igv: 16.18, discount: 0, shippingCost: 10, total: 116.08, status: 'delivered', createdAt: '2024-01-15T10:30:00Z' },
  { orderId: 'ORD-002', items: [{ productId: 'p-002', name: 'Urban Backpack', price: 45.5, quantity: 2 }, { productId: 'p-003', name: 'Wireless Earbuds', price: 35.0, quantity: 1 }], shipping: { fullName: 'Juan Perez', documentType: 'dni', documentNumber: '12345678', address: 'Av. Javier Prado 123, Lima', phone: '+51987654321', region: 'Lima' }, subtotal: 126.0, igv: 22.68, discount: 0, shippingCost: 10, total: 158.68, status: 'shipped', createdAt: '2024-02-20T14:15:00Z' },
  { orderId: 'ORD-003', items: [{ productId: 'p-004', name: 'Smart Watch Pro', price: 199.0, quantity: 1 }], shipping: { fullName: 'Juan Perez', documentType: 'dni', documentNumber: '12345678', address: 'Av. Javier Prado 123, Lima', phone: '+51987654321', region: 'Lima' }, subtotal: 199.0, igv: 35.82, discount: 0, shippingCost: 10, total: 244.82, status: 'processing', createdAt: '2024-03-10T09:00:00Z' },
  { orderId: 'ORD-004', items: [{ productId: 'p-005', name: 'Running Socks Pack', price: 12.99, quantity: 3 }], shipping: { fullName: 'Ana Torres', documentType: 'dni', documentNumber: '87654321', address: 'Av. Larco 456, Lima', phone: '+51911223344', region: 'Lima' }, subtotal: 38.97, igv: 7.01, discount: 0, shippingCost: 10, total: 55.98, status: 'cancelled', createdAt: '2024-03-25T16:45:00Z' },
  { orderId: 'ORD-005', items: [{ productId: 'p-006', name: 'Yoga Mat Premium', price: 55.0, quantity: 1 }, { productId: 'p-007', name: 'Water Bottle 1L', price: 18.5, quantity: 2 }], shipping: { fullName: 'Maria Garcia', documentType: 'dni', documentNumber: '55667788', address: 'Av. La Marina 789, Lima', phone: '+51999887766', region: 'Lima' }, subtotal: 92.0, igv: 16.56, discount: 0, shippingCost: 10, total: 118.56, status: 'confirmed', createdAt: '2024-04-05T11:20:00Z' },
  { orderId: 'ORD-006', items: [{ productId: 'p-008', name: 'Studio Desk Lamp', price: 45.5, quantity: 1 }], shipping: { fullName: 'Carlos Lopez', documentType: 'dni', documentNumber: '11223344', address: 'Jr. Union 321, Lima', phone: '+51955443322', region: 'Lima' }, subtotal: 45.5, igv: 8.19, discount: 0, shippingCost: 10, total: 63.69, status: 'pending', createdAt: '2024-04-10T08:15:00Z' },
  { orderId: 'ORD-007', items: [{ productId: 'p-009', name: 'Nimbus Hoodie', price: 58.0, quantity: 2 }], shipping: { fullName: 'Pedro Sanchez', documentType: 'dni', documentNumber: '99887766', address: 'Av. Arequipa 567, Lima', phone: '+51944332211', region: 'Lima' }, subtotal: 116.0, igv: 20.88, discount: 0, shippingCost: 10, total: 146.88, status: 'processing', createdAt: '2024-04-15T14:30:00Z' },
  { orderId: 'ORD-008', items: [{ productId: 'p-010', name: 'Vertex Sunglasses', price: 77.0, quantity: 1 }, { productId: 'p-011', name: 'City Commuter Bike Helmet', price: 68.0, quantity: 1 }], shipping: { fullName: 'Lucia Fernandez', documentType: 'dni', documentNumber: '55443322', address: 'Av. Primavera 890, Lima', phone: '+51933221144', region: 'Lima' }, subtotal: 145.0, igv: 26.1, discount: 0, shippingCost: 10, total: 181.1, status: 'shipped', createdAt: '2024-05-01T10:00:00Z' },
  { orderId: 'ORD-009', items: [{ productId: 'p-012', name: 'Pulse Yoga Mat', price: 39.0, quantity: 1 }], shipping: { fullName: 'Diego Ramirez', documentType: 'dni', documentNumber: '33221144', address: 'Av. Benavides 234, Lima', phone: '+51922114433', region: 'Lima' }, subtotal: 39.0, igv: 7.02, discount: 0, shippingCost: 10, total: 56.02, status: 'pending', createdAt: '2024-05-10T09:45:00Z' },
  { orderId: 'ORD-010', items: [{ productId: 'p-013', name: 'Brew Pour-Over Set', price: 52.0, quantity: 2 }], shipping: { fullName: 'Valeria Ortiz', documentType: 'dni', documentNumber: '66778899', address: 'Jr. Camana 123, Lima', phone: '+51911002233', region: 'Lima' }, subtotal: 104.0, igv: 18.72, discount: 0, shippingCost: 10, total: 132.72, status: 'confirmed', createdAt: '2024-05-20T16:00:00Z' },
  { orderId: 'ORD-011', items: [{ productId: 'p-014', name: 'Orbit Phone Stand', price: 24.0, quantity: 3 }], shipping: { fullName: 'Jorge Castillo', documentType: 'dni', documentNumber: '44556677', address: 'Av. Universitaria 456, Lima', phone: '+51999887700', region: 'Lima' }, subtotal: 72.0, igv: 12.96, discount: 0, shippingCost: 10, total: 94.96, status: 'delivered', createdAt: '2024-06-01T11:30:00Z' },
  { orderId: 'ORD-012', items: [{ productId: 'p-015', name: 'Harbor Chino Pants', price: 64.0, quantity: 1 }, { productId: 'p-016', name: 'Atlas Weekender Bag', price: 98.0, quantity: 1 }], shipping: { fullName: 'Sofia Martinez', documentType: 'dni', documentNumber: '22334455', address: 'Av. Salaverry 789, Lima', phone: '+51988776655', region: 'Lima' }, subtotal: 162.0, igv: 29.16, discount: 0, shippingCost: 10, total: 201.16, status: 'cancelled', createdAt: '2024-06-10T13:15:00Z' }
]
